    ...
    <div style={{ width: '100%', minHeight: '100vh', display: 'flex', background: 'white' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'rgba(217, 217, 217, 0.15)', padding: '20px 20px 20px 30px', gap: '20px' }}>
        ...
        <div style={{
          ...
          {/* Active Projects */}
          <div style={tileStyle(0)} onMouseEnter={() => setHoveredTile(0)} onMouseLeave={() => setHoveredTile(null)}>
            <div style={tileTopZone}><span style={tileLabelStyle}>Active Projects</span></div>
            <div style={tileBodyZone}>
              <div style={{ textAlign: 'center', color: '#f97316', fontSize: 48, fontFamily: 'Poppins', fontWeight: '700', lineHeight: 1 }}>67</div>
            </div>
          </div>
          ...
          {isAdminOrManager ? (
            <>
              {/* Active Contacts */}
              <div style={tileStyle(1)} onMouseEnter={() => setHoveredTile(1)} onMouseLeave={() => setHoveredTile(null)}>
                <div style={tileTopZone}><span style={tileLabelStyle}>Active Contacts</span></div>
                <div style={tileBodyZone}>
                  <div style={{ textAlign: 'center', color: '#f97316', fontSize: 48, fontFamily: 'Poppins', fontWeight: '700', lineHeight: 1 }}>28</div>
                </div>
              </div>

              {/* Tasks Due This Week */}
              <div style={tileStyle(2)} onMouseEnter={() => setHoveredTile(2)} onMouseLeave={() => setHoveredTile(null)}>
                <div style={tileTopZone}><span style={tileLabelStyle}>Tasks Due This Week</span></div>
                <div style={tileBodyZone}>
                  <div style={{ textAlign: 'center', color: '#f97316', fontSize: 48, fontFamily: 'Poppins', fontWeight: '700', lineHeight: 1 }}>14</div>
                  <div style={badgeStyle('rgba(239, 68, 68, 0.15)', '#dc2626')}>3 overdue</div>
                </div>
              </div>

              {/* Open Invoices */}
              <div style={tileStyle(3)} onMouseEnter={() => setHoveredTile(3)} onMouseLeave={() => setHoveredTile(null)}>
                <div style={tileTopZone}><span style={tileLabelStyle}>Open Invoices</span></div>
                <div style={tileBodyZone}>
                  <div style={{ textAlign: 'center', color: '#f97316', fontSize: 48, fontFamily: 'Poppins', fontWeight: '700', lineHeight: 1 }}>4</div>
            ...
            <>
              ...
              <div style={tileStyle(1)} onMouseEnter={() => setHoveredTile(1)} onMouseLeave={() => setHoveredTile(null)}>
                <div style={tileTopZone}><span style={tileLabelStyle}>Coming Soon</span></div>
                <div style={tileBodyZone}>
              ...
              {/* My Tasks Due */}
              <div style={tileStyle(2)} onMouseEnter={() => setHoveredTile(2)} onMouseLeave={() => setHoveredTile(null)}>
                <div style={tileTopZone}><span style={tileLabelStyle}>My Tasks Due</span></div>
                <div style={tileBodyZone}>
                  <div style={{ textAlign: 'center', color: '#f97316', fontSize: 48, fontFamily: 'Poppins', fontWeight: '700', lineHeight: 1 }}>5</div>
